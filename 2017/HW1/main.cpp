...
rectangular cells. Each cell is either computer, user, or empty.
...
The following (attached GIF file) is a sample animation of the game.For the detailed rules of the game see https://www.hasbro.com/common/instruct/ConnectFour.PDF
