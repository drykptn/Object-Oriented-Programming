...
public:
    ...
    void prn( const string secondValueString );
    ...
    const Memory move( const int result1,const int result2 , string secondValueString, 
                 string lastValueString, Memory& myMemoryObj );
    //This function makes addition
    const Memory add( const int result1, const int result2 ,const string secondValueString, 
                string lastValueString, Memory& myMemoryObj );
    //This function makes subtraction
    const Memory sub( const int result1, const int result2 , const string secondValueString, 
                string lastValueString, Memory& myMemoryObj );
    //This function control number and when needed its change line
    int jmp( const string secondValueString, const string lastValueString, const int jumpNum);
    //This function control number and when needed its change line
