...
CPU::CPU( const int option ):incomingOption(option){}
    ...
    if(  instruction.rfind("MOV") >= 0 && instruction.rfind("MOV") < instruction.size() ||
        ...
        {  
            ...
            if( operation.compare("MOV") == 0 )
            {
                ...
                myMemoryObj =move( result1 , result2, secondValueString, lastValueString, myMemoryObj);
            ...
            //if operation is "ADD",get into
               ...
               myMemoryObj =add(result1 , result2, secondValueString, lastValueString, myMemoryObj);
            //if operation is "SUB",get into
            else if( operation.compare("SUB") == 0 )
                myMemoryObj =sub( result1, result2 , secondValueString,lastValueString, myMemoryObj);
            ...
            // if incoming option from user is equal 1, print all the register on screen
            if( incomingOption == 1 )
                print();
            // if incoming option from user is equal 2, print all the register and address on screen
...
const Memory CPU::move( const int result1, const int result2 , string secondValueString,  
                  string lastValueString, Memory& myMemoryObj ) 
{
...
void CPU::prn( const string secondValueString )
{
